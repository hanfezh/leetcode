...
| 3	| [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters) | Medium | [C++](./algorithms/longest_substring.cpp) [Python](./algorithms/longest_substring.py) | `String` `Sliding Window` |
